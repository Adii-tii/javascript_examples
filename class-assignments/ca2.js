const user = {
    age : 21,
    name : function(){
        console.log("age is: ", this.age); // age of user obj
        console.log(this === user); //this is the curr object so return true
    }
}
...
const user2 = {
    ...
    name: () => {
        ...
        console.log(this === user); // return false now
    }
}

user2.name();

//VERY IMPORTANT!!! Objects do NOT create scope. Only functions and modules create scope